            ...
            <div  class = "background-red" style={{  border: '1px solid grey', borderRadius: '4px', minHeight:500, maxWidth: 600, margin: '3rem auto'}}>
                ...
                {this.state.timeOut == false ? this.state.setShowScore == false  ?
                    <>
                        ...
                        <Progress percent={this.state.round / dataLevel2.length * 100} status="active" />

                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 5,marginLeft: 30,}}>
                            <h2 style={{ fontSize:'2rem', color: 'black', display:'flex', justifyContent:'center'}}>দ্বিতীয় পর্বে </h2>
                        ...
                        <div  class = "background-red" style={{ padding: '2rem', borderRadius: '4px', minHeight:200, minWidth: 200, margin: '0 auto', backgroundColor: 'white'}}>
                            <div className="mb-2" style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                                {dataLevel2[this.state.NumberHolder].answerOptions.map((answerOption) => (
                    ...
                    <>
                        ...
                        <div >
                            <h1 style={{justifyContent: 'center',fontSize:'3rem', color: "white", display: this.state.correctAnswer == 10 ? 'flex' : 'none' }}>
                                You Won a Pendrive!! </h1>
                            <br></br>
                            <div style={{ display: 'flex', justifyContent: 'space-evenly',display: this.state.correctAnswer == 10 ? 'flex' : 'none' }}>
                                <img src={pendrive} alt="pendrive Image" height={200} width={240} />
                            </div>
                    ...
                    <>
                        <div >
                            ...
                            <h1 style={{ display: 'flex', justifyContent: 'center'  ,color: "white"}}>
                                অংশগ্রহণের জন্য তোমাকে ধন্যবাদ</h1>
